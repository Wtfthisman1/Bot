...
deploy() {
    ...
    if run_on_server "cd /root/Bot && export BOT_TOKEN=REDACTED_BOT_TOKEN && export ADMIN_CHAT_ID=REDACTED_CHAT_ID && export GITHUB_REPOSITORY=Wtfthisman1/Bot && docker-compose up -d"; then
...
start() {
    ...
    run_on_server "cd /root/Bot && export BOT_TOKEN=REDACTED_BOT_TOKEN && export ADMIN_CHAT_ID=REDACTED_CHAT_ID && export GITHUB_REPOSITORY=Wtfthisman1/Bot && docker-compose up -d"
